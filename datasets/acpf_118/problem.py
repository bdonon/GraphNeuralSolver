...
class Problem:
    ...
    def __init__(self):
        ...
        self.B_mean = np.array([0, -16.7, 0.638, 0.374, 0.071428])
        self.B_std = np.array([78.88, 17.68, 0.47915, 0.50514, 0.2575])
        self.A_mean = np.array([0.0, 0.0, 2871, 1.025])
        self.A_std = np.array([1.0, 1.0, 3890, 1.36])
